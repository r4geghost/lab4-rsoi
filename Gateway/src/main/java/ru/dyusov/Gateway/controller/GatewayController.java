...
public class GatewayController {
    ...
    @GetMapping("/flights")
    public FlightListResponse testFlights(@RequestParam int page, @RequestParam int size) {
...
//        HttpHeaders headers = new HttpHeaders();
//        ResponseEntity<FlightListResponse> response = (ResponseEntity<FlightListResponse>)
